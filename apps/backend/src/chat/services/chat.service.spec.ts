...
describe('ChatService', () => {
  ...
  describe('chat', () => {
    it('should return an Observable', () => {
      const result = service.chat('How does flanking work?', mockUser);
      expect(result).toBeDefined();
      expect(typeof result.subscribe).toBe('function');
    });

    it('should emit sources event first', async () => {
      const events = await collectEvents(service.chat('test', mockUser));
    ...
    it('should pass message to embedding service', async () => {
      await collectEvents(service.chat('How does flanking work?', mockUser));
    ...
    it('should pass embedding to vector search', async () => {
      await collectEvents(service.chat('test', mockUser));
    ...
    it('should handle conversation history', async () => {
      ...
      await collectEvents(service.chat('Tell me more', mockUser, history));
    ...
    it('should handle chunks with no results', async () => {
      ...
      const events = await collectEvents(service.chat('obscure question', mockUser));
      const sourcesEvent = events.find((e) => e.type === 'sources');
      expect(sourcesEvent).toBeDefined();
      if (sourcesEvent!.type === 'sources') {
